        ...
        return (
            <div className="min-h-screen text-base-content p-4 xl:p-8">
                <header className="text-center mb-10 space-y-4">
                    ...
                    <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight text-base-content">
                        Market Snapshot
                    </h1>

                    <p className="text-base-content/80 max-w-2xl mx-auto text-sm xl:text-base">
